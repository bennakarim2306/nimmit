...
export default class DriveCard extends Component {
    ...
    render() {
        const {userName, numberOfDrives, note, from_address, from_distance, destination_address, destination_distance, date, departure_time_min, departure_time_max, price} = this.props.drive;
        return (
