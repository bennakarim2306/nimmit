...
import { Button, View, Text, Block } from "../Components";
      ...
      <Block>
        <Block center bottom flex={0.4}>
          ...
          <Text h3 gray2 style={{ marginTop: theme.sizes.padding / 2 }}>
            Nimm mit für dich, die Umwelt und Spaß 
          </Text>
        </Block>
        <Block center middle>
          <Image style={styles.image_logo} resizeMode='contain' source={require('../assets/logo.png')}> 
          </Image>
        </Block>
